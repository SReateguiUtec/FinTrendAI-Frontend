...
function AnimatedCounter({
    ...
    return (
        ...
        >
            <motion.div
                className={cn(
                    'text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black mb-4 sm:mb-6 whitespace-nowrap tracking-tighter',
                )}
                initial={{ scale: 0.8 }}
            ...
            <motion.p
                className={cn(
                    'text-zinc-400 dark:text-zinc-500 text-[10px] sm:text-xs font-medium leading-tight px-1 sm:px-2 uppercase tracking-wide',
                )}
    ...
    return (
        ...
        >
            ...
            >
                <h2
                    className={cn(
                        'text-xs sm:text-sm md:text-base font-bold tracking-[0.2em] uppercase text-zinc-500 dark:text-zinc-400',
                    )}
                >
                ...
                >
                    {stats.map((stat, index) => (
                        <div
                            key={index}
                            className={cn(
                                'flex-1 min-w-0 flex flex-col justify-start',
                            )}
                        >
                            <div className="relative w-full flex flex-col justify-center flex-1">
                                <AnimatedCounter
                                    value={stat.value}
                                    suffix={stat.suffix}
