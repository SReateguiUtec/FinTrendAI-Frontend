...
function AnnouncementComponent({
    ...
    const badgeContent = (
        <Badge
            className={cn(
                'group relative max-w-full overflow-hidden rounded-full bg-zinc-900/60 px-4 py-1.5 font-medium border border-white/10 shadow-2xl backdrop-blur-md',
                className,
            )}
            variant={variant}
                    ...
                    <div className='relative overflow-hidden rounded-full bg-transparent p-px'>
                        <div className='absolute inset-0 pointer-events-none'>
                            <MovingBorder duration={movingBorderDuration} rx='50%' ry='50%'>
                                <div
                                    className={cn(
                                        'h-12 w-12 bg-[radial-gradient(#0ea5e9_50%,transparent_70%)] opacity-30 blur-sm',
                                        movingBorderClassName,
                                    )}
                                />
                            </MovingBorder>
...
export function AnnouncementTag({
    ...
    const tagContent = (
        <span
            className={cn(
                'relative inline-flex items-center gap-2 px-3 py-1 text-[11px] font-medium rounded-full bg-white/5 text-zinc-400 border border-white/5',
                className,
            )}
            {...props}
        >
