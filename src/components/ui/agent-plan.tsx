...
const initialTasks: Task[] = [
    {
        ...
        description:
            "Obtener historial de precios y velas del activo.",
        status: "pending",
        priority: "high",
        level: 0,
        dependencies: [],
        ...
        subtasks: [
            {
                ...
                description: "Calcular el peso relativo entre la tendencia de precio y el sentimiento general.",
                status: "pending",
                priority: "high",
            ...
            },
            {
                ...
                description: "Generar la recomendación final de Compra, Venta o Mantener con su nivel de confianza.",
                status: "pending",
                priority: "high",
...
export default function Plan({ currentStep = -1 }: PlanProps = {}) {
    ...
    // Auto progression based on real network state
    useEffect(() => {
        if (currentStep < 0) {
        ...
        // Ensure the current task is expanded
        if (currentStep >= 0 && currentStep < initialTasks.length) {
            setExpandedTasks(prev => {
                const taskId = initialTasks[currentStep].id;
